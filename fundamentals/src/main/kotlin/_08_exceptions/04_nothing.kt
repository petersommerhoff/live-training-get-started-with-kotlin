...
fun main(args: Array<String>) {
  ...
  // Note: check inferred type
  val input = nameOrNull() ?: fail("Please enter a username")
  input.trim()
...
//  val nothing: Nothing = ?
  ...
  // (4c) There's no Nothing type in Java (everything has at least null), see [_08_exceptions.JClass]
}